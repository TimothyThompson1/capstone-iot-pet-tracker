...
/*spi pin source*/
#define SPI_PORT (spi_device_handle_t)SPI2_HOST
#define PIN_SCK  11
#define PIN_MOSI 12
#define PIN_MISO 13
#define PIN_CS   (gpio_num_t)10
...
#define PIN_SDA  18
#define PIN_SCL  19
#define WRITE_BIT 0x78 //TODO:Review
...
class ArduCAM 
{
  ...
  void OV5640_set_Banding_Filter(uint8_t Banding_Filter);
	...
	esp_err_t spi_write_blocking(spi_device_handle_t spi, const uint8_t *src, size_t len);
	esp_err_t spi_read_blocking(spi_device_handle_t spi, uint8_t repeated_tx_data, uint8_t *dst, size_t len);
	esp_err_t i2c_write_blocking(i2c_port_t i2c_num, uint8_t addr, const uint8_t *src, size_t len, bool nostop);
	esp_err_t i2c_read_blocking(i2c_port_t i2c_num, uint8_t addr, uint8_t *dst, size_t len, bool nostop);
...
//void spi_write_blocking(spi_device_handle_t spi, const uint8_t *src, size_t len);
//void spi_read_blocking(spi_device_handle_t spi, uint8_t repeated_tx_data, uint8_t *dst, size_t len);
