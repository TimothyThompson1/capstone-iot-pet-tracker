...
// Define a struct for sensor register configuration
struct sensor_reg {
	uint16_t reg;
	uint8_t val;
};

const struct sensor_reg ov5642_RAW[]  =
{
{0x3103,0x03},
{0x3008,0x82},
{0x3017,0x7f},
...
const struct sensor_reg ov5642_640x480[]  =
{
	{0x3800 ,0x1 },
	{0x3801 ,0xa8},
	{0x3802 ,0x0 },
...
const struct sensor_reg ov5642_1280x960[]  =
{
	{0x3800 ,0x1 },
	{0x3801 ,0xB0},
	{0x3802 ,0x0 },
...
const struct sensor_reg ov5642_1600x1200[]  =
{
	{0x3800 ,0x1 },
	{0x3801 ,0xB0},
	{0x3802 ,0x0 },
...
const struct sensor_reg ov5642_1024x768[]  =
{
	{0x3800 ,0x1 },
	{0x3801 ,0xB0},
	{0x3802 ,0x0 },
...
const struct sensor_reg ov5642_2048x1536[]  =
{
	{0x3800 ,0x01},
	{0x3801 ,0xb0},
	{0x3802 ,0x00},
...
const struct sensor_reg OV5642_720P_Video_setting[]  = 
{
	{0x3103 ,0x93},
	{0x3008 ,0x82},
	{0x3017 ,0x7f},
